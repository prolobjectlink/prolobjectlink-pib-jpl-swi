...
public class SwiBenchmarkRunner extends AbstractBenchmarkRunner implements BenchmarkRunner {
	...
	public static class ExecutionPlan {
		...
		public void setUp() {
			...
			provider = Prolog.getProvider(SwiProlog.class);
...
//                  D is ( P * 100 ) / A.
	...
	public static void main(String[] args) throws RunnerException {
		...
		builder.include(SwiBenchmarkRunner.class.getSimpleName());
		Options opt = builder.build();
		Collection<RunResult> run = new Runner(opt).run();
		new SwiBenchmarkRunner().output(run);
